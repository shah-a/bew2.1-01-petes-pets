...
/*
 * These tests were working fine closer to the beginning of the tutorial,
 * but started to break as we changed things around. By the last page
 * of the tutorial, most of these tests started to fail. The last test
 * for checking JSON responses for APIs (which was introduced in the tutorial's
 * last page) is working fine, though.
 */
